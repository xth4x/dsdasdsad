...
exports.run = async (client, message) => {
  ...
  if (secenekler !== "aç" && secenekler !== "kapat" && secenekler !== "on" && secenekler !== "off") return message.reply("aç veya kapat yaz!")
    ...
    message.delete();
        ...
        message.channel.send("**Topluluk Etiket Sistemi :** **Açık!**").then(m => m.delete(5000));
  ...
  if(!hereEngel[message.guild.id]){
    ...
    exports.help = {
        ...
        description: 'Topluluk Etiket Sistemini açıp kapatmanızı sağlar.',
